...
:root.forced-colors {
    ...
    --theme-button-dark-text: var(--color-system-linktext);
    --theme-button-dark-text-hover: var(--color-system-linktext);
    --theme-button-dark-background: var(--color-system-canvas);
    --theme-button-dark-background-hover: var(--color-system-canvas);
